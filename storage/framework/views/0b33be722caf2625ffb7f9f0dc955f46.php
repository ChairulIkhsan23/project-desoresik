<?php $__env->startSection('title', 'Dashboard Petugas Pengangkut Sampah'); ?>
            ...
            <div class="card shadow-sm border-0 overflow-hidden" style="background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80') center/cover no-repeat;">
                <div class="card-body text-white">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="badge bg-light text-dark">Jumat <?php echo e(\Carbon\Carbon::now()->format('d M Y')); ?></span>
                        <div class="text-end">
...
<?php echo $__env->make('layouts.app-petugas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-desoresik\resources\views/petugas/dashboard.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Jadwal Pengangkutan'); ?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="<?php echo e(asset('assets/img/photos/container-kosong.jpg')); ?>" width="60" height="60" style="object-fit: cover;" class="rounded">
                                </td>
...
<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-desoresik\resources\views/admin/jadwal-pengangkutan/index.blade.php ENDPATH**/ ?>
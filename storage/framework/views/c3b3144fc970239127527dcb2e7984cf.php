...
<?php $__env->startSection('title', 'Tambah Armada'); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.armada.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nomor_polisi" id="nomor_polisi" 
                                               class="form-control <?php $__errorArgs = ['nomor_polisi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                               value="<?php echo e(old('nomor_polisi')); ?>" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="tahun_kendaraan" id="tahun_kendaraan" 
                                               class="form-control <?php $__errorArgs = ['tahun_kendaraan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                               value="<?php echo e(old('tahun_kendaraan')); ?>" required 
...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <option value="Truk" <?php echo e(old('jenis') == 'Truk' ? 'selected' : ''); ?>>Truk</option>
                                        </select>
...
<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\project-desoresik\resources\views/admin/armada/create.blade.php ENDPATH**/ ?>
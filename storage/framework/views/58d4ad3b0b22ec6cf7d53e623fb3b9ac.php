...
<body style="font-family: 'Times New Roman', Times, serif; color: #000; padding: 40px; margin: 0;">
    ...
    <div class="kop-surat">
        <div class="logo-container">
            <img src="<?php echo e($base64); ?>" alt="Logo" class="logo">
        </div>
    ...
    <p style="margin: 0 0 10px 0;"><strong><?php echo e($petugas->name); ?></strong><br>Di Tempat</p>
    ...
    <table style="margin-left: 20px; margin-bottom: 20px;">
        <tr>
            <td style="padding: 5px 10px;">Nama</td><td style="padding: 5px 10px;">:</td><td style="padding: 5px 10px;"><strong><?php echo e($petugas->name); ?></strong></td>
        </tr>
        <tr>
            <td style="padding: 5px 10px;">Email</td><td style="padding: 5px 10px;">:</td><td style="padding: 5px 10px;"><?php echo e($petugas->email); ?></td>
        </tr>
        <tr>
            <td style="padding: 5px 10px;">No HP</td><td style="padding: 5px 10px;">:</td><td style="padding: 5px 10px;"><?php echo e($petugas->no_hp); ?></td>
        </tr>
        <tr>
            <td style="padding: 5px 10px;">Role</td><td style="padding: 5px 10px;">:</td><td style="padding: 5px 10px;"><?php echo e($petugas->role); ?></td>
        </tr>
        <tr>
            <td style="padding: 5px 10px;">Status</td><td style="padding: 5px 10px;">:</td><td style="padding: 5px 10px;"><?php echo e($petugas->status); ?></td>
        </tr>
        <tr>
            <td style="padding: 5px 10px;">Password</td><td style="padding: 5px 10px;">:</td>
            <td style="padding: 5px 10px;"><span style="background: #eee; padding: 3px 8px; border-radius: 4px; font-family: monospace;"><?php echo e($password); ?></span></td>
        </tr>
    </table>
    ...
    <div style="width: 100%; text-align: right; margin-top: 50px;">
        <p style="margin: 0 0 10px 0;">Indramayu, <?php echo e(\Carbon\Carbon::now()->format('d F Y')); ?></p>
...
<?php /**PATH C:\laragon\www\project-desoresik\resources\views/pdf/info_akun_petugas.blade.php ENDPATH**/ ?>
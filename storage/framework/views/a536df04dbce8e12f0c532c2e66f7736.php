<nav id="sidebar" class="sidebar js-sidebar">
    ...
    <a class="sidebar-brand" href="<?php echo e(route('admin.dashboard')); ?>">
        ...
        <img src="<?php echo e(asset('assets/img/photos/dlh.jpg')); ?>" alt="Logo 3" style="height: 40px;">
    </a>
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item <?php echo e(request()->routeIs('admin.lokasi.index') ? 'active' : ''); ?>">
                <a class="sidebar-link" href="<?php echo e(route('admin.lokasi.index')); ?>">
            ...
            <li class="sidebar-item <?php echo e(request()->routeIs('admin.absensi') ? 'active' : ''); ?>">
                <a class="sidebar-link" href="<?php echo e(route('admin.absensi')); ?>">
...
<?php /**PATH C:\laragon\www\project-desoresik\resources\views/layouts/partials-petugas/sidebar.blade.php ENDPATH**/ ?>
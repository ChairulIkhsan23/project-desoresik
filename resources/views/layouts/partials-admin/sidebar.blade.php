<nav id="sidebar" class="sidebar js-sidebar">
    ...
    <a class="sidebar-brand" href="{{ route('admin.dashboard') }}">
        ...
        <div style="background: white; border-radius: 30px; padding: 2px; display: inline-block;">
            <img src="{{ asset('assets/img/photos/logo-klhk.png') }}" alt="Logo 3" style="height: 30px;">
        </div>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.petugas.index') ? 'active' : '' }} ">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.armada.index') ? 'active' : '' }} ">
                <a class="sidebar-link" href="{{ route('admin.armada.index') }}">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.tps.index') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ route('admin.tps.index') }}">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.jadwal-pengangkutan') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ route('admin.jadwal-pengangkutan') }}">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.laporan-kendala') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ route('admin.laporan-kendala') }}">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.absensi.index') ? 'active' : '' }}">

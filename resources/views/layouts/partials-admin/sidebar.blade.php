<nav id="sidebar" class="sidebar js-sidebar">
    ...
    <a class="sidebar-brand" href="{{ route('admin.dashboard') }}">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.data-petugas') ? 'active' : '' }} ">
                <a class="sidebar-link" href="{{ route('admin.data-petugas') }}">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.data-armada') ? 'active' : '' }} ">
                <a class="sidebar-link" href="{{ route('admin.data-armada') }}">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.lokasi-tps') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ route('admin.lokasi-tps') }}">
